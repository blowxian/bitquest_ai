...
export const metadata: Metadata = {
    title: 'meta ai search engine',
    description: 'meta ai ：your key to smart and efficient ai searches. join us for a quick, accurate, and reliable ai search experience.',
